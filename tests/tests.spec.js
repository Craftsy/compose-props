...
import {mapStateToProps, mapPropsOnChange, setPropTypes, setStateTypes, compose} from '../src/composeProps.js';
...
describe('compose-props', ()=>{
  ...
  describe('compose()', ()=>{
    ...
    it('should work with any function that takes in (state, props), and return last functions returned object', ()=>{
      ...
      expect(finalProps).to.deep.equal(lastProps);
    });

    describe('works with other compose-props functions', ()=>{
